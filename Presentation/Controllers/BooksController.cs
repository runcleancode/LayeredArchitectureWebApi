...
namespace Presentation.Controllers
{
    ...
    public class BooksController : ControllerBase
    {
        ...
        public async Task<IActionResult> UpdateOneBookAsync([FromRoute(Name = "id")] int id, [FromBody] BookDtoForUpdate bookDto)
        {
            ...
            // ModelState holds the validation status. If invalid, it is automatically serialized into a JSON error response.
            if (!ModelState.IsValid)
                return UnprocessableEntity(ModelState);
        ...
        public async Task<IActionResult> PartiallyUpdateOneBookAsync([FromRoute(Name = "id")] int id, [FromBody] JsonPatchDocument<BookDtoForUpdate> bookPatch)
        {
            ...
            //Sistemde dönüşmüş geçerli entity nesnesinin değiştiği yer burası bu nedenle buradan sonra kontrol işlemi eklendi . TryValidateModel
